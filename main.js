...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6282138899290@s.whatsapp.net`, {text: 'Ok,berhasil bang,dah bisa terhubung ke sc DI https://youtube.com/channel/UCgpGp677PH-tKorzNuGwhrw oke bang tank you' })
}
